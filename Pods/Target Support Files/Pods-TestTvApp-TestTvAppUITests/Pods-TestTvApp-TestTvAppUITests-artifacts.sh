...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  install_xcframework "${PODS_ROOT}/Mux-Stats-Core/XCFramework/MuxCore.xcframework" "" "true" "tvos-arm64/MuxCoreTv.framework" "tvos-arm64_x86_64-simulator/MuxCoreTv.framework"
fi
